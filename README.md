...
The service worker initialization code is disabled by default. To enable it, uncomment the following code in `src/app/app.config.ts`:
...
Edit [src/app/app.config.ts](src/app/app.config.ts) file:
